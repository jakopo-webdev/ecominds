  ...
  private missions: MissionDetail[] = [
    {
      ...
      objectives: [
        ...
        "🍽️ Discover new vegetarian meals and flavors",
      ],
      steps: [
      ...
      tips: [
        ...
        "🌶️ Add flavor with spices and herbs—they're key to not missing meat",
    ...
    },
    {
      ...
      objectives: [
        ...
        "🛠️ Learn simple techniques to conserve water at home",
      ],
      steps: [
        ...
        "⏲️ Use a timer when showering or watering plants",
        "🔄 Collect and reuse water when possible (e.g., leftover drinking water to water plants)",
        "🗣️ Talk about it: Share what you're doing with friends or family to spread awareness",
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        "🗺️ Research or visit a nearby recycling point (this could be a municipal center, a supermarket drop-off spot, or public recycling bins)",
        ...
        "🗂️ Sort them properly into categories: plastic, paper, glass, metal, organic waste, or reusable items",
    ...
    },
    {
      ...
      objectives: [
        ...
        "🛠️ Propose 3 or more practical green upgrades",
    ...
    },
    {
      ...
      steps: [
        ...
        "🗺️ Create your personal sustainable mobility plan: Plan to share at least one ride per week to start",
      ],
      tips: [
        "📢 Use community boards or WhatsApp groups to coordinate shared trips",
        "🛍️ Combine shopping with shared trips to save time and emissions",
        "🏛️ Ask your local council if a program like MuevetEX is available in your area",
